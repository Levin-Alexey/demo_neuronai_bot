...
async def ai_manager_main_menu(message: types.Message, state: FSMContext):
    ...
    <i>«Я готова спроектировать Вашу AI систему будущего в реальном времени».</i>

    🤖 <b>Мои возможности:</b>
    - Мгновенный расчет сметы по Вашим параметрам
    - Подбор стека технологий (RAG, Python, n8n)
    - Анализ внедрения ИИ

    <b>Выберите действие ниже, для запуска процесса:</b>"""
