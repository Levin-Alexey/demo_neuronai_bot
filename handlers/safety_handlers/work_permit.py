...
async def work_permit_handler(message: types.Message, state: FSMContext):
    ...
    await message.answer(
        "📝 <b>Цифровой Наряд-допуск (Smart Permit)</b>\n\n"
        "Я перевела бюрократию на язык технологий. Больше никаких бумажных журналов.\n"
        "Оформите допуск любым удобным способом — я пойму и голос, и текст.\n\n"
        "⚙️ <b>Выберите режим оформления:</b>\n\n"
        "🎙 <b>Голосом (AI Speed):</b>\n"
        "Идеально для «полевых» условий. Грязные руки? Просто скажите: <i>«Варим трубу в пятом цеху»</i>. "
        "Я сама заполню документ за 5 секунд.\n\n"
        "📋 <b>Вручную (Classic):</b>\n"
        "Пошаговая форма с кнопками. Используйте, если вокруг шумно или нужна точность.\n\n"
        "👇 <b>Как вам удобнее оформить заявку сейчас?</b>",
        parse_mode="HTML",
